    ...
    def __init__(
        ...
        if not is_peft_available() and peft_config is not None:
            ...
            if getattr(model, "is_loaded_in_8bit", False) or getattr(model, "is_loaded_in_4bit", False):
                ...
                print(f'prepare_model_kwargs={prepare_model_kwargs}, _support_gc_kwargs={_support_gc_kwargs}, getattr(model, "is_loaded_in_8bit", False)={getattr(model, "is_loaded_in_8bit", False)}')
            ...
            print(f'get_peft_model, peft_config={peft_config}')
